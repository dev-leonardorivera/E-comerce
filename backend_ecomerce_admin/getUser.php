...
$sql= "SELECT adminuser.ID_ADMIN , adminuser.NOMBER, adminuser.APELLIDO, adminuser.ID_ADMIN from adminuser WHERE adminuser.EMAIL = '".$EMAIL."' AND adminuser.PASS = '".$PASS ."'";
