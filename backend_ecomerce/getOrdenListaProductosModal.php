...
$ID = $datos['ID'];
$sql= "SELECT product.NOMBRE, orden_producto.ID_PRODUCT, product.PRECIO from orden_producto INNER JOIN product on orden_producto.ID_PRODUCT = product.ID_PRODUCT WHERE orden_producto.ID_ORDEN = '".$ID."';";
